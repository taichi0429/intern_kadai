  ...
  <div class="page">
    ...
    <form action="/trip/edit/<?php echo $trip['id']; ?>" method="POST">
      ...
      <div class="form-group">
        ...
        <input class="form-input" type="text" id="title" name="title" value="<?php echo $trip['title']; ?>" required>
      </div>
      <div class="form-group">
        <label class="form-label" for="target_weight">目標重量（g）：</label>
        <input class="form-input" type="number" id="target_weight" name="target_weight" value="<?php echo $trip['target_weight']; ?>" min="1">
      </div>
